...
mod tests {
    ...
    #[test]
    fn default_browser_root_keeps_existing_home_layout() {
        let home = env::temp_dir().join(format!("okf-platform-macos-{}", std::process::id()));
        env::set_var("HOME", &home);
        assert_eq!(default_browser_root(), home.join("docs-browser"));
    }
}
