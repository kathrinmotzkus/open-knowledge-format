...
- Clarified the crates.io installation path:
  `cargo install okf-http --locked`, followed by
  `okf-http --install-browser`.
- Clarified the difference between installing from crates.io and installing
